  ...
  "inline-flex items-center relative justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        primary:
          "after:custom-transition relative z-10 bg-primary font-semibold text-white after:absolute after:-right-1.5 after:-z-10 after:hidden after:h-[120%] after:w-[90%] after:rounded-lg after:border-4 after:border-primary after:content-[''] hover:after:w-2/5 after:lg:block",
        common:
